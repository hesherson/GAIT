// GAIT 1.8.0-alpha10: set ACE heartbeat playback gain to 20% of the original.
...
// 20% amplitude is 0.224403691, equivalent to approximately -12.9794 dB.
...
class CfgSounds
{
    ...
    {
        sound[] = {"\z\ace\addons\medical_feedback\sounds\fast_1.wav", 0.224403691, 1};
    };
    class ACE_heartbeat_fast_2
    {
        sound[] = {"\z\ace\addons\medical_feedback\sounds\fast_2.wav", 0.224403691, 1};
    };
    class ACE_heartbeat_fast_3
    {
        sound[] = {"\z\ace\addons\medical_feedback\sounds\fast_3.wav", 0.224403691, 1};
    };
    class ACE_heartbeat_norm_1
    {
        sound[] = {"\z\ace\addons\medical_feedback\sounds\norm_1.wav", 0.224403691, 1};
    };
    class ACE_heartbeat_norm_2
    {
        sound[] = {"\z\ace\addons\medical_feedback\sounds\norm_2.wav", 0.224403691, 1};
    };
    class ACE_heartbeat_slow_1
    {
        sound[] = {"\z\ace\addons\medical_feedback\sounds\slow_1.wav", 0.224403691, 1};
    };
    class ACE_heartbeat_slow_2
    {
        sound[] = {"\z\ace\addons\medical_feedback\sounds\slow_2.wav", 0.224403691, 1};
    };
};
