 ...
 * clips, and five Mrun lateral/backward clips. The controller enters once;
...
class CfgMovesBasic
{
    ...
    for family, actions, parent in FAMILIES:
        lines += [f"        class {parent};", f"        class {actions}: {parent}", "        {"]
    ...
    for family, actions, _ in FAMILIES:
        ...
        for direction in directions:
            ...
            lines.append("            // Direct idle/direction routes plus explicit native release endpoints.")
            internal = [custom(family, other) for other in directions if other != direction]
